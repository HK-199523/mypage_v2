                                ...
                                <div className="grid gap-4 ">
                                    ...
                                    { techNews.map((item) =>(
                                        ...
                                        <div className="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                                            <a href="{item.id}" className="group relative hidden md:block h-48 w-full shrink-0 self-start overflow-hidden bg-gray-100 md:h-full md:w-32 lg:w-48">
                                                <img src={`http://localhost:8080${item.Image}`} loading="lazy" alt="Photo by Minh Pham" className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                                            </a>
                                            ...
                                            <div className="flex flex-col gap-2 p-4 lg:p-6">
                                                ...
                                                <div> 
                                                    {item.Tags.map((tag,index) =>(
                                                        <button id={tag.Tag_id} className="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md bg-black text-cyan-400 border border-cyan-500 hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-200 cursor-pointer">
                                                            {tag.Tag_name}
                                                        </button>
                                                    ))}
                                                </div>
